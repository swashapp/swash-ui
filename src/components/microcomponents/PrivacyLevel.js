...
class PrivacyLevel extends React.Component {
  ...
  render() {
    ...
    const rangeSelector = <PrivacySelector handleClick={(value) => this.setPrivacy(value)} activeNav={this.state.level} />;

    return (
      <>
        <div className="privacy-block">{rangeSelector}</div>
        <div>
          <MDBTable>
            <MDBTableHead>
            ...
            <MDBTableBody>{privacyTableDataRows}</MDBTableBody>
          </MDBTable>
        </div>
