                    ...
                    <div className="onboarding-box">
                            ...
                            <div>
                                <div className="onboarding-box-body-radio">
                                    <CustomRadioBox
                                        ...
                                        isChecked={this.state.userType === "Create"}
                                    />
                                ...
                                <div className="onboarding-box-body-radio">
                                    <CustomRadioBox
                                        id="Import"
                                        handleClick={this.radioChangeHandler}
                                        isChecked={this.state.userType === "Import"}
                                    />
                        ...
                        <div className="onboarding-box-footer">
                            ...
                            <div className="onboarding-box-footer-right">
                                <div className='onboarding-proceed-button' onClick={this.LoadOnBoardingNew}>Next</div>
                            </div>
                        </div>
                    </div>
                </React.Fragment>
